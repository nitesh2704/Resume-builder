...
export default function Sidebar() {
  ...
  return (
    <aside className="no-print fixed inset-y-4 left-4 z-30 hidden w-72 flex-col rounded-2xl border border-green-200/70 bg-gradient-to-b from-white/80 via-green-50/80 to-emerald-100/80 p-4 shadow-card backdrop-blur-xl dark:border-emerald-900/60 dark:from-gray-950/90 dark:via-emerald-950/70 dark:to-black/80 lg:flex">
